...
const Footer = () => {
  return (
    <footer>
      <footer className="mt-auto bg-customPurple w-full dark:bg-neutral-950">
        <div className="mt-auto w-full max-w-[85rem] py-4 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div className="col-span-1">
              <h4 className="font-semibold text-gray-100">Sports</h4>
              ...
              <div className="mt-3 grid space-y-3">
                ...
                <p>
                  ...
                  <span className="inline-block ms-1 text-xs bg-customPink text-white py-1 px-2 rounded-lg">
                    Live Now!
                  </span>
                </p>
                <p>
            ...
            <div className="col-span-2">
              <h4 className="font-semibold text-gray-100">Join the Fun</h4>
              ...
              <form>
                <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                  ...
                  <a
                    className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-customPink text-white hover:bg-customDarkerPink focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                    href="#"
                  >
                    Register
                  </a>
                ...
                Stay updated on the latest bonuses!
                </p>
              </form>
            </div>
          </div>
